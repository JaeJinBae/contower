...
function draw_emptyroom(info){
	...
	var rtype = "";
	var str = "";
	str = "<table><tr><th>건물명</th><th>호실</th><th>금액</th><th>타입</th><th>난방</th><th>옵션</th><th>PW</th><th>현관/준공</th><th>관리자</th></tr>";
	if(json.list.length == 0){
		str += "<tr><td colspan='9' style='text-align:center;font-size:18px;'>등록된 정보가 없습니다.</td></tr></table>";
