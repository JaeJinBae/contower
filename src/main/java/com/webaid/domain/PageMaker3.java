...
public class PageMaker3 {
	...
	public String makeSearch(int page){
		UriComponents uriComponents=UriComponentsBuilder.newInstance().queryParam("page", page)
																		...
																		.queryParam("searchType", ((SearchCriteria3)cri).getSearchType())
																		.queryParam("keyword1", ((SearchCriteria3)cri).getKeyword1())
																		.queryParam("keyword2", ((SearchCriteria3)cri).getKeyword2())
																		.queryParam("keyword3", ((SearchCriteria3)cri).getKeyword3()).build();
